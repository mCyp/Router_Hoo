...
import com.example.shoe.ui.anim.CusChangeOnlineImageTransition
import com.wj.common.constant.UrlConstant
import com.wj.common.ui.widget.PhotoView

const val GALLERY_URL = "GALLERY_URL"
const val TRANSITION_NAME = "TRANSITION_NAME"
@Route(path = UrlConstant.IMAGE_URL)
class ImageGalleryActivity : AppCompatActivity() {
    ...
    private fun initView(){
        ...
        mPhotoView.setExitListener(object : PhotoView.OnExitListener {
            override fun exit() {
